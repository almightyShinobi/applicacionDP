          ...
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
                @if($errors->any())
                    ...
                    <div class="alert alert-danger mb-4 " role="alert" placeholder="Error en las credenciales">
                        {{ $errors->first()}}
                    </div>
                @else
                    <div class="text-center text-muted mb-4">
                        <small>Ingresa tus datos para crear una cuenta nueva </small>
                    </div>
                @endif
                  ...
                  <div class="col-12">
                    <div class="custom-control custom-control-alternative custom-checkbox">
                      ...
                      <label class="custom-control-label" for="customCheckRegister">
                        <span class="text-muted">Estoy de acuerdo con los <a href="{{ asset('img/foto.png')}}">Privacy Policy</a></span>
                      </label>
                    </div>
                  </div>
                </div>
                <div class="text-center">
                  <button type="sumbit" class="btn btn-primary mt-4">Crear Cuenta</button>
                </div>
              </form>
            </div>
          </div>
